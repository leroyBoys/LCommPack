...
public class CardId {
	...
	*
     ...
     */
    public  Date getBirthday(String cardId) throws Exception {
        Date birthday;
...
// } 
    ...
    public  String checkEffect(String cardId) {
...
// } 
     ...
     * @create by soft at 2009-7-9
     */
    public  String toEighteenId(String cardId) {
        if (cardId.length() != 15) {
            return cardId;
        }
     ...
     *
     * @param num 个数
     * @param year 从1920年开始第几年出生
     * @create by szq at 2009-8-19
     */
    public  String genCardId(int num, int startYear, int year) {
        return genCardId(num, "d:\\cardId.txt", startYear, year);
    }
     ...
     * @create by szq at 2009-8-19
     */
    public  String genCardId(int num) {
        return genCardId(num, "d:\\cardId.txt", 0, 10);
    }
     ...
     * @param num 个数
     * @param filePath 文件路径
     * @param startYear 从2010年开始第几年出生 startYear 从startYear开始 randomYear
     * @param randomYear 随机randomYear 年内
     * @return 
     * @create by szq at 2009-8-19
     */
    public  String genCardId(int num, String filePath, int startYear, int randomYear) {
        String ret = "";
        FileWriter fw = null;
        if (startYear < 1000) {
            startYear = 1980;
	...
	// 定义一个properties文件的名字 
            ...
            for (int i = 0; i < num; i++) {
                ret = getCardId(startYear, randomYear);
                fw.write(ret + "        " + DateTimeTool.format(this.getBirthday(ret), "yyyy-MM-dd HH:mm:ss"));
                fw.write("\r\n");
            }
    ...
    public  String getCardId(int startYear, int randomYear){
        Object[] code = properties.keySet().toArray();
        int size = code.length;
        Random random = new Random();
        String areaCode = (String) code[random.nextInt(size)];
        int year = startYear + random.nextInt(randomYear);
        ...
        return areaCode + birthday + randomCode + verify;
    }
    /**
     * @param args
     * @create by soft at 2009-7-8
    ...
    public static  void main(String[] args) {
        try {
            ...
            System.out.println(cd.genCardId(10, 1987, 1));
            ;
        } catch (Exception e) {
            e.printStackTrace();
        }
