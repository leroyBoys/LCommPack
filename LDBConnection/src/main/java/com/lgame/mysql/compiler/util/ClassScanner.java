...
public class ClassScanner {
     ...
     * @return
     */
    public static Set<Class<?>> getClasses(String pack,boolean scanJar) {
                            ...
                            if (name.startsWith(packageDirName)) {
                                ...
                                if ((idx != -1) || recursive) {
                                    ...
                                    if (name.endsWith(".class")&& !entry.isDirectory()) {
                                        ...
                                        try {
                                            // 添加到classes
                                            addClass(classes,Class.forName(packageName + '.'+ className));
        ...
        for (File file : dirfiles) {
            ...
            if (file.isDirectory()) {
                ...
                //没有使用classLoader的load干净
                    addClass(classes,Thread.currentThread()
                            .getContextClassLoader()
